...
function _readMainSync() {
  // Hàm này chỉ dùng để bootstrap đầu — block với deasync, hoặc trả về cached
  if (_cache) return _cache;
  // Lần đầu chưa init → return seed tạm, async init sau
  console.warn('[DB-MySQL] ⚠️  load() before initAsync — return seed tạm thời');
  return seed();
}
