...
async function generateMatchPreview(match) {
  ...
  const prompt = [
    ...
    '',
    '6. PHONG CÁCH:',
    '   - Chuyên nghiệp, dùng từ ngữ thể thao Việt Nam (phong độ, tốt thủ, hậu vệ, tiền vệ, tiền đạo, hàng công, hàng thủ, sân nhà, sân khách)',
    '   - Tránh lặp từ, văn chương trôi chảy',
    '   - Mỗi paragraph 3-5 câu',
    '',
    '7. KHÔNG được làm:',
