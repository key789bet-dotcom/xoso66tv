 ...
 */
const PREMIUM_GIFTS = [
  { id:'p_rose',    name:'Hoa hồng VIP',  icon:'🌹', priceVnd:10000,   streamerCut:0.70, tier:'vip',    anim:'zoom',    msg:'tặng bó hoa hồng VIP' },
  { id:'p_bear',    name:'Gấu bông sang', icon:'🧸', priceVnd:20000,   streamerCut:0.70, tier:'vip',    anim:'zoom',    msg:'tặng gấu bông siêu cute' },
  { id:'p_cake',    name:'Bánh kem 3 tầng',icon:'🎂',priceVnd:50000,   streamerCut:0.72, tier:'vip',    anim:'zoom',    msg:'tặng bánh kem 3 tầng' },
  { id:'p_ring',    name:'Nhẫn kim cương',icon:'💍',priceVnd:100000,  streamerCut:0.72, tier:'royal',  anim:'ring',    msg:'cầu hôn idol bằng nhẫn kim cương 💍' },
  { id:'p_crown',   name:'Vương miện vàng',icon:'👑',priceVnd:200000, streamerCut:0.75, tier:'royal',  anim:'ring',    msg:'tôn vinh Idol bằng vương miện vàng' },
  { id:'p_ferrari', name:'Siêu xe Ferrari',icon:'🏎️',priceVnd:500000, streamerCut:0.75, tier:'royal',  anim:'fly',     msg:'tặng siêu xe Ferrari đỏ rực' },
  { id:'p_yacht',   name:'Du thuyền sang',icon:'🛥️',priceVnd:1000000,streamerCut:0.78, tier:'legend', anim:'fly',     msg:'tặng du thuyền siêu sang ra Phú Quốc' },
  { id:'p_rocket',  name:'Tên lửa vũ trụ',icon:'🚀',priceVnd:2000000,streamerCut:0.80, tier:'legend', anim:'explode', msg:'bắn tên lửa vũ trụ! Idol là số 1 🚀' }
];
