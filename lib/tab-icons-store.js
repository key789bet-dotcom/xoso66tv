...
const VALID_KEYS = [
  // Tab trang chủ
  'hot', 'thethao', 'idol', 'casino', 'esport',
  // Tab chat phòng live BLV (tw-live.ejs)
  'chat_room', 'chat_telegram', 'chat_facebook',
  // Nút CTA "ĐĂNG KÝ NHẬN 100% TIỀN THƯỞNG" (BLV chat)
  'cta_register',
  // Tab chat phòng IDOL (tw-idol-room.ejs)
  'idol_chat', 'idol_gift',
  // Nút "ĐĂNG KÝ TÀI KHOẢN XOSO66" (idol chat)
  'cta_register_xoso66'
];
